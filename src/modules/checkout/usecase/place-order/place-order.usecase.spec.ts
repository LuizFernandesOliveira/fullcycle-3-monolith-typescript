...
describe("PlaceOrderUseCase unit test", () => {
  ...
  describe("ValidateProducts methods", () => {
    ...
    it("should throw error if no products are selected", async () => {
      ...
      await expect(useCase["validateProducts"](input)).rejects.toThrowError("No products selected");
    });
    ...
    it("should throw an error when product is out of stock", async () => {
      ...
      await expect(useCase["validateProducts"](input)).rejects.toThrowError("Product 1 is not available in stock");
  ...
  describe("getProducts method", () => {
    ...
    it("should throw an error when product is not found", async () => {
      ...
      await expect(useCase["getProduct"]("1")).rejects.toThrowError("Product 1 not found");
    });
    ...
    it("should return a product", async () => {
      ...
      await expect(useCase["getProduct"]("0")).resolves.toEqual(new Product({
        id: new Id("0"),
        name: "Product 0",
        description: "Product 0 description",
        salesPrice: 0,
